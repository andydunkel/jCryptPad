			...
			for(int i = 0; i < movedPaths.length; i++) 
				...
				if(!moveNode.equals(targetNode)) 
                                {	
                                    ...
                                    Enumeration moveNodeChilds = moveNode.children();
                                    boolean childOf = false;
                                                                        
                                    while (moveNodeChilds.hasMoreElements())
                                    {
                                        MutableTreeNode node = (MutableTreeNode)moveNodeChilds.nextElement();                                        
                                        if (node.equals(targetNode)) childOf = true;
                                    }
